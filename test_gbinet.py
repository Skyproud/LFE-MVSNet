...
def test(rank, cfg):
    ...
    test_dataset = MVSDataset(cfg["data"]["test"]["root_dir"], 
        ...
        depth_num=cfg["data"]["test"].get("depth_num", 4),
...
def main():
    ...
    parser.add_argument("--cfg", dest="config_file", default="./configs/test_custom.yaml", metavar="FILE", help="path to config file", type=str)
