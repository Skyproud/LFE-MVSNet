...
class GBiNet(nn.Module):
    ...
    def forward_all_depth(self, data_batch, max_tree_depth, prob_out_depth=5):
        ...
        for i in range(num_view):
            ...
            # print(curr_feature_map['0'].shape)
        ...
        for curr_tree_depth in range(1, max_tree_depth + 1):
            ...
            current_depths, current_tree = \
                depth_update_clean.update_4pred_4sample(curr_tree_depth, current_tree, pred_label, depth_start, depth_end, is_first)
            is_first = False
            ...
            if next_depth_stage != stage_id:
                current_depths, current_tree = \
                    depth_update_clean.depthmap2tree(depth_est, curr_tree_depth + 1, depth_start=depth_start,
    ...
    def forward(self, data_batch, max_tree_depth=None, prob_out_depth=5, **kwargs):
